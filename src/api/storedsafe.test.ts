...
export default class TestDriver implements RequestDriver {
  ...
  async request({
    ...
    if (this.options == null)
      throw new Error("[TestDriver] No mock parameters set.");
...
describe("after authentication", () => {
  ...
  describe("/vault", () => {
    ...
    test(".vaultObjects", () => {
      ...
      return storedsafe.vaultObjects(id).then((res) => {
        expect(res.status).toBe(200);
      });
    });
    ...
    test(".vaultMembers", () => {
      ...
      return storedsafe.vaultMembers(id).then((res) => {
        expect(res.status).toBe(200);
      });
    });
    ...
    test(".addVaultMember", () => {
      ...
      return storedsafe.addVaultMember(id, id2, status).then((res) => {
        expect(res.status).toBe(200);
      });
    });
    ...
    test(".editVaultMember", () => {
      ...
      return storedsafe.editVaultMember(id, id2, status).then((res) => {
        expect(res.status).toBe(200);
      });
    });
    ...
    test(".removeVaultMember", () => {
      ...
      return storedsafe.removeVaultMember(id, id2).then((res) => {
        expect(res.status).toBe(200);
      });
    });
    ...
    test(".createVault", () => {
      ...
      return storedsafe.createVault(params).then((res) => {
        expect(res.status).toBe(200);
      });
    });
    ...
    test(".editVault", () => {
      ...
      return storedsafe.editVault(id, params).then((res) => {
        expect(res.status).toBe(200);
      });
    });
    ...
    test(".deleteVault", () => {
      ...
      return storedsafe.deleteVault(id).then((res) => {
        expect(res.status).toBe(200);
      });
    });
  }); // END VAULT
  ...
  describe("/object", () => {
    test(".object, default (no children)", () => {
      ...
      return storedsafe.getObject(id).then((res) => {
        expect(res.status).toBe(200);
      });
    });
    ...
    test(".object, no children", () => {
      ...
      return storedsafe.getObject(id, false).then((res) => {
        expect(res.status).toBe(200);
      });
    });
    ...
    test(".object, with children", () => {
      ...
      return storedsafe.getObject(id, true).then((res) => {
        expect(res.status).toBe(200);
      });
    });
    ...
    test(".decryptObject", () => {
      ...
      return storedsafe.decryptObject(id).then((res) => {
        expect(res.status).toBe(200);
      });
    });
    ...
    test(".createObject", () => {
      ...
      return storedsafe.createObject(params).then((res) => {
        expect(res.status).toBe(200);
      });
    });
    ...
    test(".editObject", () => {
      ...
      return storedsafe.editObject(id, params).then((res) => {
        expect(res.status).toBe(200);
      });
    });
    ...
    test(".deleteObject", () => {
      ...
      return storedsafe.deleteObject(id).then((res) => {
        expect(res.status).toBe(200);
      });
    });
  }); // END OBJECT
  ...
  describe("/template", () => {
    test(".listTemplates", () => {
      ...
      return storedsafe.listTemplates().then((res) => {
        expect(res.status).toBe(200);
      });
    });
    ...
    test(".getTemplate", () => {
      ...
      return storedsafe.getTemplate(id).then((res) => {
        expect(res.status).toBe(200);
      });
    });
  }); // END TEMPLATE
  ...
  describe("/user", () => {
    test(".listUsers", () => {
      ...
      return storedsafe.listUsers().then((res) => {
        expect(res.status).toBe(200);
      });
    });
    ...
    test(".getUser", () => {
      ...
      return storedsafe.getUser(id).then((res) => {
        expect(res.status).toBe(200);
      });
    });
    ...
    test(".createUser", () => {
      ...
      return storedsafe.createUser(params).then((res) => {
        expect(res.status).toBe(200);
      });
    });
    ...
    test(".deleteUser", () => {
      ...
      return storedsafe.deleteUser(id).then((res) => {
        expect(res.status).toBe(200);
      });
    });
  }); // END USER
  ...
  describe("/utils", () => {
    test(".statusValues", () => {
      ...
      return storedsafe.statusValues().then((res) => {
        expect(res.status).toBe(200);
      });
    });
    ...
    test(".passwordPolicies", () => {
      ...
      return storedsafe.passwordPolicies().then((res) => {
        expect(res.status).toBe(200);
      });
    });
    ...
    test(".version", () => {
      ...
      return storedsafe.version().then((res) => {
        expect(res.status).toBe(200);
      });
    });
    ...
    test(".generatePassword", () => {
      ...
      return storedsafe.generatePassword().then((res) => {
        expect(res.status).toBe(200);
      });
    });
    test(".generatePassword", () => {
      ...
      return storedsafe.generatePassword(params).then((res) => {
        expect(res.status).toBe(200);
      });
    });
  }); // END UTILS
...
describe("with global options", () => {
  ...
  beforeEach(() => {
    storedsafe = new StoredSafe(
      { host, token, options: GLOBAL_OPTIONS },
      "1.0",
      driver
    );
  });

  test("Merge global options with nested request options", () => {
    driver.mock({
    ...
    return storedsafe["request"]("GET", "/", {}, {}, {}, REQUEST_OPTIONS).then(
      (res) => {
        expect(res.status).toBe(200);
      }
    );
