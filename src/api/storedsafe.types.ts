import type { RequestResponse } from "../drivers/request-driver.types"

export interface StoredSafeResponse<T extends StoredSafeData = StoredSafeData, U = any> extends RequestResponse<U> {
  success: boolean
  errors?: string[]
